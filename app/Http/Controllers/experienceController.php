...
class experienceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard.experience.index')->with('data', $data);
    }
    ...
    {
        return view('admin.dashboard.experience.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'tgl_mulai.required' => 'Tangal Mulai wajib diisi',
    ...
    public function edit($id)
    {
        ...
        return view('admin.dashboard.experience.edit')->with('data', $data);
    }
