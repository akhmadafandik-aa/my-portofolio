...
class halamanController extends Controller
{
    ...
    public function index()
    {
        ...
        // var_dump($data); die();
        return view('admin.dashboard.halaman.index')->with('data', $data);
    }
    ...
    {
        return view('admin.dashboard.halaman.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.dashboard.halaman.edit')->with('data', $data);
    }
